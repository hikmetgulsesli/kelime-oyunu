...
import { evaluateGuess, isValidGuess, getDailyWord, LetterResult } from '../utils/wordUtils';
...
export function useGame() {
  ...
  const targetWord = useMemo(() => getDailyWord(today), [today]);
